...
enum CompetitionCatalog {
    static let entries: [CompetitionCatalogEntry] = [
        ...
        CompetitionCatalogEntry(id: "tr-super-lig", countryCode: "tr", leaguePackId: AppLeaguePackId.turkeyTop3.rawValue, name: "Süper Lig", type: .domesticLeague, level: 1, groupKey: nil, sortOrder: 90, isPrimaryDomestic: true, isPremiumEligible: true, aliases: ["super lig", "süper lig"]),
        CompetitionCatalogEntry(id: "tr-1-lig", countryCode: "tr", leaguePackId: AppLeaguePackId.turkeyTop3.rawValue, name: "1. Lig", type: .domesticLeague, level: 2, groupKey: nil, sortOrder: 91, isPrimaryDomestic: true, isPremiumEligible: true, aliases: ["1. lig", "1 lig", "tff 1. lig"]),
        CompetitionCatalogEntry(id: "tr-2-lig-beyaz-grup", countryCode: "tr", leaguePackId: AppLeaguePackId.turkeyTop3.rawValue, name: "2. Lig Beyaz Grup", type: .domesticLeague, level: 3, groupKey: "beyaz", sortOrder: 92, isPrimaryDomestic: true, isPremiumEligible: true, aliases: ["2. lig beyaz grup", "2 lig beyaz grup", "tff 2. lig white group"]),
        CompetitionCatalogEntry(id: "tr-2-lig-kirmizi-grup", countryCode: "tr", leaguePackId: AppLeaguePackId.turkeyTop3.rawValue, name: "2. Lig Kırmızı Grup", type: .domesticLeague, level: 3, groupKey: "kirmizi", sortOrder: 93, isPrimaryDomestic: true, isPremiumEligible: true, aliases: ["2. lig kirmizi grup", "2 lig kirmizi grup", "2. lig kırmızı grup", "tff 2. lig red group"]),
        CompetitionCatalogEntry(id: "tr-1-lig-playoffs", countryCode: "tr", leaguePackId: AppLeaguePackId.turkeyTop3.rawValue, name: "1. Lig - Slutspil", type: .domesticLeague, level: nil, groupKey: "playoff", sortOrder: 94, isPrimaryDomestic: false, isPremiumEligible: true, aliases: ["1. lig slutspil", "1. lig playoffs", "tff 1. lig playoffs"]),
